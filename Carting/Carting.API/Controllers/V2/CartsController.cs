...
namespace Carting.Carting.API.Controllers.V2
{
    [ApiController]
    [ApiVersion("2.0")]
    ...
    public class CartsController : ControllerBase
    {
        ...
        /// Returns carts items
        /// </summary>
        /// <param name="id">id of a cart whose items should be retrieved</param>
        /// <returns>List of items</returns>
        [MapToApiVersion("2.0")]
        [HttpGet("{id}")]
        [ProducesResponseType(typeof(Cart), StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public async Task<IActionResult> GetCartItems([FromRoute] string id)
        {
